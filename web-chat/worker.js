...
<div id="cheat" class="wrap">
  ...
  <div class="card" style="border-color:#2c5740">
    <div class="grp">경기 규칙 (현장 발표 확정)</div>
    <ul>
      <li><b>경기 시간 = 정규 2분 + 연장 1분</b> (초단기 → 빨리 배포·빠른 튜닝)</li>
      <li>승점 <b>승3 / 무1 / 패0</b>. 조별 라운드로빈 → <b>조 상위 2팀 16강 토너먼트</b>(조 교차)</li>
      <li>동점이면 <b>골든골 연장</b>(먼저 넣는 팀 승)</li>
      <li><b>Gateway가 "패스 확률·슛 평가" 전술 툴 제공</b> → 선수가 이 공식 툴 부르게 하면 강해짐</li>
      <li>전술 용어(프롬프트용): 점유·반격·고위압박·측면공격·<b>지역방어(공간 지키고 사람 안 쫓음=핵심)</b>·맨마킹·컴팩트</li>
    </ul>
  </div>
  ...
  <div class="card"><ul>
    <li><b>프롬프트</b>: 포지션별 차별화 — 우리 프롬프트가 그 역할(공간/전진/마크)을 박아둠</li>
    <li><b>모델 선택</b>: 포지션마다 사고깊이 vs 응답속도 요구가 다름 → 다른 모델 조합</li>
    <li><b>포지션 협응</b>: 단일 선수 최적화 ✗ → 선수끼리 맞물리게(존 규율). anti-swarm 프롬프트가 이걸 함</li>
    <li><b>상황 인지</b>: 스코어·시간·체력 따라 전략 동적 조정 (지면 공격적, 이기면 잠금)</li>
    <li><b>로그 관찰(CloudWatch)</b>: 경기 중 선수 결정 과정을 봄 = 왜 졌는지 디버깅</li>
    <li><b>세부 튜닝</b>: 슛 강도·패스 방식·압박 타이밍 <b>한 번에 하나씩</b> (동시 ✗)</li>
    <li><b>도구·단기기억</b>: 언제 전술도구 부를지 + 경기 중 상대 행동 패턴을 기억해 대응</li>
